...
* **https://chat.ijug.eu[Matrix-Chat]** (inkl. Slack-Bridge): Für größere Diskussionen ist eine Mailingliste wie all-vertreter oft nicht der richtige Ort. Daher können diese in den entsprechenden Matrix-Channels geführt werden. Mehr Infos unter https://cloud.ijug.eu/index.php/f/34099

* **https://events.ijug.eu[Mobilizon]**: Eine quelloffene, dezentrale, föderierte Event-Plattform. Hier können Veranstaltungen erstellt und verwaltet werden. Mitglieder und Gruppen können hierüber auch Veranstaltungen veröffentlichen, die dann im java.de-Kalender auftauchen.
...
* **https://uptime.fihlon.swiss/status/ijug[Status-Seite]**: Auf der Status-Seite des iJUG können Mitglieder den aktuellen Status der iJUG-Dienste einsehen. Diese wird extern gehostet um bei einem Ausfall der iJUG-Infrastruktur Auskunft geben zu können.
